...
e&&20<Math.abs(f-a.pageX)&&(g=f>a.pageX?"left":"right")}).on("mouseup",function(){e=!1;"left"==g?r.click():"right"==g&&q.click()})}function p(){for(var f=a.navigation,d=k("<div class=navigation />").css({position:"relative",bottom:0,left:700}),b=0;b<g;b++)d.append("<div class=nav></div>");"circles"==f?d.find(".nav").css({border:"1px dashed #ccc",borderRadius:"12px"}):"squares"==f&&d.find(".nav").css({border:"1px ridge #fff"});d.find(".nav").css({display:"inline-block",margin:"5px",cursor:"pointer",
